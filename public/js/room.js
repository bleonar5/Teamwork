function Toastify (options) {
  ...
  function addView (id, show) {
      ...
      style: "position: absolute;top: 0;left: 0;display: block;width: 100%;z-index: 2;color: #fff;opacity: 0.9;text-shadow: black 0.1em 0.1em 0.2em;font-size: 10px;"
        }).appendTo("#remote_video_panel_" + id);
    ...
    function removeView (id) {
      if (jQuery("#remote_video_panel_" + id)[0]) {
        jQuery("#remote_video_panel_"+id).remove();
      }
    }
  ...
  function handleEvents (rtc) {
      ...
      rtc.client.on("stream-subscribed", function (evt) {
        ...
        if(remoteStream.audio && !remoteStream.video){
          jQuery('#player_'+id).css({'background-image': 'url(https://harvard.az1.qualtrics.com/CP/File.php?F=F_abJc4DaI9xFd8zj)','background-size':'100% 100%','border':'solid black','display':'block'});
        }
      ...
      if (params.cameraId != null && audioOnly != "true")
        ...
        video = false;
          ...
          rtc.localStream.init(function () {
            ...
            //if (rtc.localStream.audio && !rtc.localStream.video)
              //jQuery('#player_'+rtc.params.uid).css({'background-image': 'url(https://harvard.az1.qualtrics.com/CP/File.php?F=F_abJc4DaI9xFd8zj)','background-size':'100% 100%','border':'solid black','display':'block'});
